    ...
    <header class="container-fluid d-flex align-items-center topo">
        <div class="container d-flex align-items-center">
            ...
            <div class="col-2 text-center favoritos">
                <a href="" class="p-2 favoritos bg-black" data-bs-toggle="modal" data-bs-target="#modal-login"><i class="fa-solid fa-user"></i> Entre ou Cadastre-se</a>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Entrar como Cliente ou Administrador?</h5>
